...
def generate_image_with_text(text):
    ...
    cv2.putText(image, text, (int(image.shape[0]*0.28), int(image.shape[1]*0.5)), font, 3, (255, 255, 255), 2, cv2.LINE_AA)
    return image
...
while start_time < end_time:
    ...
    print(cv2.imwrite('time_images/{0}.jpg'.format(text), image))
#    print(text, image)
